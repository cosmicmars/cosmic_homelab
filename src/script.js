...
import { startAutoUpdate, stopAutoUpdate } from "./services/apiUpdater.js"; // FIX: правильный путь
...
function initServerModal() {
    ...
    console.log('✅ applyBtn.onclick для сервера:', server.id); 
        ...
        cardTypes.forEach(ct => {
            ...
            // Рисуем график сразу (для всех карточек)
...
async function fetchInitialData(serverId) {
    ...
    try {
        ...
        console.log('✅ fetchInitialData успех:', cpuData, uptimeData, ipData);
        return {
